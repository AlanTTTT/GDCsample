...
jQuery(document).ready(function () {
    ...
    var events = [
        {
            date: 'April 2016',
            content: 'Magic Compass Ltd is authorized to practice in Europe!'
        },
        {
            date: 'December 2019',
            content: 'Magic Compass Securities Limited has officially joined the Group!'
        },    
        {
            date: 'October 2021',
            content: 'Magic Compass Investments Limited is established today! '
        },
        {
            date: 'April 2022',
            content: 'Magic Compass International Capital Ltd has officially joined the Group!'
        },
        {
            date: 'July 2022',
            content: 'Magic Compass Financial Services OÜ has officially joined the Group！ '
        }
    ];
